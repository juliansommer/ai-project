...
def start():
    ...
    tools = [
        ...
        Tool(
            ...
            description="useful for specifically gathering tables from a wikipedia page. will need to call the function with the link. data retrieved will need to be trimmed. Accepts a single string as input.",
        ),
